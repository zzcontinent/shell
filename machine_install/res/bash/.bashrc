...
if [ "$color_prompt" = yes ]; then
	PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\][\u:\$(who|wc -l)]\[\033[00m\]\[\033[31;1m\][\$(uptime |cut -d, -f1,4|awk '{printf(\"%s][%d/\"), \$7,\$3}'|tr -d ',')\$(date +%m%d)_\t]\[\033[00m\]:\[\033[01;34m\][\w]\[\033[00m\]\$ "
