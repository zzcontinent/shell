...
if [ "$color_prompt" = yes ]; then
	PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\][\u:\$(who|wc -l)]\[\033[00m\]\[\033[31;1m\][\$(uptime|cut -d' ' -f13|tr -d ',')][\$(date +%m%d)][\t]\[\033[00m\]:\[\033[01;34m\][\w]\[\033[00m\]\$ "
	#PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\][\u@\h]\[\033[00m\]\[\033[31;1m\][\$(date +%y%m%d) \t]\[\033[00m\]:\[\033[01;34m\][\w]\[\033[00m\]\$ "
else
    #PS1='${debian_chroot:+($debian_chroot)}\u@\h\t\:\w\$ '
    PS1="${debian_chroot:+($debian_chroot)}[\u:\$(who|wc -l)][\$(uptime|cut -d' ' -f13|cut -d ',')][\$(date +%m%d)][\t]:[\w]\$ "
fi
if [ ${USER} == root ];then
    PS1='${debian_chroot:+($debian_chroot)}[\u@\h\t]:[\w]\$ '
fi
